# getstat/apis/tags/schemas/ranking_distributions.py
"""Schema for the tags.ranking_distributions() API method.

https://help.getstat.com/knowledgebase/requests-and-responses/#tagsranking
...
class RankingDistributionsRequest(BaseModel):
    """Schema to validate the params parsed to tags.ranking_distributions()."""
...
class RankingCounts(BaseModel):
    """Schema for the ranking counts within "Google" and "GoogleBaseRank" keys of tags.ranking_distributions()."""
...
class RankDistributionEntry(BaseModel):
    """Schema for the "RankDistribution" key in tags.ranking_distributions()."""
...
class Response(BaseResponseModel):
    """Schema for the 'Response' key in tags.ranking_distributions()."""
...
class RankingDistributionsResponse(BaseModel):
    """Top-level schema for tags.ranking_distributions() response."""
